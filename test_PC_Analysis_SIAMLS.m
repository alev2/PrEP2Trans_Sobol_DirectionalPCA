...
outputRoot='./PrepToTransGroups/testResult_SIAMLS/simulation_';
outputRootPrEP='./PrepToTransGroups/testResult_SIAMLS/simulationNumPrEP_';
...
baselineDirection=[0;0;0;0];

principalDirections=[zeros(4,1) principalDirections];
