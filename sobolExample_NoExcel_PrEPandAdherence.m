...
%                  ann_PctOnART ann_PctVLSamongdiag ann_PctVLSamongdiag_Blk ann_PctVLSamongdiag_Hisp ann_PctVLSamongdiag_Oth];
    ...
    outputMatrix=[ann_NewInfections_MSM ann_NewInfections_HETF ann_NewInfections_HETM ann_NewInfections_PWID ann_NewInfections_Total spending... 
...
values_g7 = 0*ones(num_Yrs,nb_pts); % num prep msm
values_g8 = 0*ones(num_Yrs,nb_pts); % num prep hetf
values_g9 = 0*ones(num_Yrs,nb_pts); % num prep hetm
values_g10 = 0*ones(num_Yrs,nb_pts); % num prep pwid
values_g11 = 0*ones(num_Yrs,nb_pts); % pct on prep msm
values_g12 = 0*ones(num_Yrs,nb_pts); % pct on prep hetf 
values_g13 = 0*ones(num_Yrs,nb_pts); % pct on prep hetm
