...
outputRoot='./Results_MixingAndPrEP_SIAMLS_Example/simulation_';
...
domain = [int_p1',int_p2',int_p3', int_p4'];% int_p11' int_p12' int_p13' int_p14' int_p15' int_p16' ]; % define the N-dim. domain - we need this in the function that computes the Sobol indices 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
knots = {knots_1,knots_2,knots_3, knots_4};% knots_11 knots_12 knots_13 knots_14 knots_15 knots_16}; 
...
%   [Sob_g14,Tot_Sob_g14,m14,v14,vi14,vti14] = compute_sobol_indices_from_sparse_grid_with_history(S,Sr, Vi14_All, VTi14_All, v14_new, values_g14(j,:),domain,'legendre'); 
...
%     [Sob_g14,Tot_Sob_g14,m14,v14] = compute_variance_decomposition_from_sparse_grid(S,Sr,values_g14(j,:),domain,'legendre'); 
