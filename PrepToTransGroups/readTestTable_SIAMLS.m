sobolExamples_Setup
outputRoot='./testResult_SIAMLS/simulation_';
...
values_g1_Test = 0*ones(num_Yrs,nb_pts); % incidence msm
values_g2_Test = 0*ones(num_Yrs,nb_pts); % incidence hetf
values_g3_Test = 0*ones(num_Yrs,nb_pts); % incidence hetm
values_g4_Test = 0*ones(num_Yrs,nb_pts); % incidence pwid
values_g5_Test = 0*ones(num_Yrs,nb_pts); % incidence total
...
testOutputs=[sum(values_g1_Test(startIndex:endIndex,:)); sum(values_g2_Test(startIndex:endIndex,:)); sum(values_g3_Test(startIndex:endIndex,:));...
             sum(values_g4_Test(startIndex:endIndex,:)); sum(values_g5_Test(startIndex:endIndex,:))];%UAsum(values_g6_Test(startIndex:endIndex,:));];
