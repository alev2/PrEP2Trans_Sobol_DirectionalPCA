...
outputRoot='./datasetInput_LargeScaleKappa/simulation_';
...
for i=1:nb_pts
    ...
    Parameters_Cur(indsPrEPBlack)=...
            ExcelValues_AllParameters(indsPrEPBlack)*prepMult_Black_SimVal;
    Parameters_Cur(indsPrEPHisp)=...
            ExcelValues_AllParameters(indsPrEPHisp)*prepMult_Hisp_SimVal;
    fprintf('done.\n');
