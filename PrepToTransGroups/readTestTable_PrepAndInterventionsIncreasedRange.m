sobolExamples_Setup
outputRoot='./testResult_PrepAndInterventions_IncreasedRange/simulation_';
...
testOutputs=[sum(values_g1_Test(startIndex:endIndex,:)); sum(values_g2_Test(startIndex:endIndex,:)); sum(values_g3_Test(startIndex:endIndex,:));...
             sum(values_g4_Test(startIndex:endIndex,:)); sum(values_g5_Test(startIndex:endIndex,:));sum(values_g6_Test(startIndexCost:endIndex,:));];
