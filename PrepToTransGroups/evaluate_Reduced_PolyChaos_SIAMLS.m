...
evalDomain_Base=ones(1,4)*.5;
evalDomain_Base2=[0 0 0 0];
evalDomain_Base3=[1 1 1 1];
newDir=Vk*(Sk\Uk')*((UApx'*(stdMat\([425000; 55000; 30000; 28000;538000] - rowMeans(:,1)) )));
newDir2=Vk*(Sk\Uk')*((UApx'*(stdMat\([400000; 55000; 30000; 28000;513000] - rowMeans(:,1)) )));
newDir3=Vk*(Sk\Uk')*((UApx'*(stdMat\([375000; 55000; 30000; 28000;488000] - rowMeans(:,1)) )));
...
evalDomain=[evalDomain_Base' evalDomain_Base2' evalDomain_Base3' evalDomain_Base'+newDir evalDomain_Base'+newDir2 evalDomain_Base'+newDir3 evalDomain_Base'+principalDirections];
